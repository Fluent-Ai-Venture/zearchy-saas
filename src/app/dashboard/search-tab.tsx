...
export default function SearchTab({ dataId }: SearchTabProps) {
  ...
  const performSearch = useCallback(async () => {
    ...
    try {
      ...
      const searchUrl = `/api/search?q=${encodeURIComponent(searchQuery)}&dataId=${encodeURIComponent(dataId)}`;
      ...
      if (response.ok && data.results) {
        ...
        // Visualization data handling removed - now only used in local search tab
      } else {
  ...
  }, [searchQuery, dataId, performSearch]);
